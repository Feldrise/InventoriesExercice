...
namespace InventoriesExercise.API.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private readonly IInventoriesExerciseSettings _InventoriesExerciseSettings;

        public AuthenticationService(IMongoSettings mongoSettings, IInventoriesExerciseSettings InventoriesExerciseSettings)
        {
            ...
            _InventoriesExerciseSettings = InventoriesExerciseSettings;
        }
        ...
        private string TokenForUser(User user)
        {
            ...
            var key = Encoding.ASCII.GetBytes(_InventoriesExerciseSettings.ApiSecret);
